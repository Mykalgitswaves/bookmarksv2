<template>
  <div class="container grid place-content-center min-w-[280px] max-w-[500px]">
    <form class="grid grid-cols-1 gap-5">
      ...
      <span class="block">
        <label class="block font-semibold" for="first_name">Your full name</label>
        <input class="w-80 px-4 py-2 mt-2 rounded-md border-2 border-indigo-200" type="text" />
      </span>
      ...
      <div class="grid grid-cols-5 gap-3">
        ...
        <span
          class="col-span-1 rounded-md border-solid border-2 border-slate-400 py-2 px-2 hover:border-indigo-500 duration-300 nowrap"

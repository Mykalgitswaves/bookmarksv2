        ...
        >   
            ...
            <div class="nav-menu-option w-100">
                <button 
                    class="space-y-2 flex items-center gap-2 text-sm fancy text-stone-600 hover:bg-stone-100 w-100 p-2"
                    typ="button"
                    @click="$router.push(navRoutes.bookClubSettingsManageMembersIndex(route.params.user, route.params.bookclub))"
                >
            ...
            <div class="nav-menu-option w-100">
                <button 
                    class="space-y-2 flex items-center gap-2 text-xs fancy text-stone-600 hover:bg-stone-100 w-100 p-2"
                    typ="button"
                    @click="$router.push(navRoutes.bookClubSettingsCurrentlyReading(route.params.user, route.params.bookclub))"
                >

<template>
      ...
      <div class="card-footer">
        ...
        <div class="flex items-center">
          ...
          >
            ...
            <span v-if="likes > 0" class="like-count">
              {{ likes }}
            </span>
          </button>
          ...
          <button
            ...
            type="button"
            title="comment"
            class="btn btn-tiny btn-icon mr-auto btn-specter b-0 relative ml-2"
  ...
  <div v-if="post.type === 'club_review'" class="card club club-review-post">
    <div class="card-header">
      <p class="text-slate-600 text-center">
    ...
    <div class="card-content-main">
      ...
      <div v-if="post.book" class="c_c_m_inner mb-0">
        <p
          class="text-xl font-semibold mb-2 text-indigo-600 cursor-pointer title-hover"
    ...
    <div class="card-responses">
      ...
      <ul class="my-3 content-start">
        <li v-for="(r, index) in post.responses" :key="index" class="card-commonalities">
    ...
    <div class="card-footer">
      <div class="flex gap-2">
        ...
        <button
          type="button"
          class="text-slate-600 flex items-center relative b-0 m-r-5"
...
function grantOrUngrantAward(award, vForIndex) {
  ...
  if (!award.granted_by_current_user) {
    db.put(
      urls.bookclubs.grantAwardToPost(route.params.bookclub, props.post.id, award.id),
      null,
      false,
    ...
    db.delete(
      urls.bookclubs.ungrantAwardToPost(route.params.bookclub, props.post.id, award.id),
      null,
      false,

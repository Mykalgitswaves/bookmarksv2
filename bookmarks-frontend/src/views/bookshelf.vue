    ...
    >    
        <div class="mt-10">
            ...
            <div class="flex flex-row gap-2 justify-start mt-5 mx-4">
                <button class="justify-self-end w-40 bg-indigo-600 text-indigo-100 px-6 py-2 rounded-md hover:bg-indigo-700 duration-300">Write a review</button>
                <button class="justify-self-end w-40 bg-slate-600 text-indigo-100 px-6 py-2 rounded-md hover:bg-slate-700 duration-300">Update status</button>
            </div>
